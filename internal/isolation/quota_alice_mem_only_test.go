...
func TestBug_AliceMemOnly_Request2049m_ShouldBeAllowed(t *testing.T) {
	...
	newBody, qr, err := CheckAndInjectQuota(body, quota, 1001, db, qm.GetDefaultQuota().CPUCores, qm.GetDefaultQuota().MemMB)
...
func TestRegression_AliceMemOnly_ExceedsMemQuota_DeniedWithMemoryError(t *testing.T) {
	...
	_, qr, err := CheckAndInjectQuota(body, quota, 1001, db, qm.GetDefaultQuota().CPUCores, qm.GetDefaultQuota().MemMB)
...
func TestRegression_BobNoEntry_InheritsDefaultsUnaffectedByAlice(t *testing.T) {
	...
	_, qr2, err2 := CheckAndInjectQuota(body2048, quota, 1002, db, qm.GetDefaultQuota().CPUCores, qm.GetDefaultQuota().MemMB)
	if err2 != nil {
...
func TestRegression_AliceExplicitZeroCPU_MeansUnlimited_NotInherited(t *testing.T) {
	...
	db := newBugTestDB(t)
	body := memOnlyBody(2049)
	newBody, qr, err := CheckAndInjectQuota(body, got, 1001, db, qm.GetDefaultQuota().CPUCores, qm.GetDefaultQuota().MemMB)
	if err != nil {
